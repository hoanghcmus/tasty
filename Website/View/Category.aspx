<%@ Page Title="" Language="C#" MasterPageFile="~/View/SubMaserPage.master" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="View_Category" %>
                    ...
                    <ItemTemplate>
                        <li data-lien-ket="<%#ShowItem(Container.DataItem, "LienKet") %>" class="item-link">
                            <a href="javascript:void()" class="link">
                                <i class="dot"></i><span><%#Eval("TieuDe_Vn") %></span>
                            </a>
                            <i class="sep"></i>
                        </li>
                    </ItemTemplate>
