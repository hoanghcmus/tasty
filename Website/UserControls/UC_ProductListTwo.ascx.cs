...
public partial class UserControls_ProductListTwo : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            List<DataAccess.Classes.Product> listPR = DataAccess.Classes.Product.LayTheoIDTheLoai(IDTheLoai);
