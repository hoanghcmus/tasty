<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_ProductListOne.ascx.cs" Inherits="UserControls_UC_ProductListOne" %>
<div class="product-list-wrapper">
    ...
    <div class="product-list-content">
        ...
        <div class="advertisement">
            <asp:HyperLink ID="lbtAdvertisementLink" runat="server" CssClass="link">
                <asp:Image ID="imgAdvertisementFigure" runat="server" CssClass="img" />
                <div class="ad-title">
                    <h1>
                        <asp:Label ID="lbAdvertisementTitle" runat="server" Text="Tiêu đề quảng cáo"></asp:Label></h1>
                </div>
            </asp:HyperLink>
        </div>
