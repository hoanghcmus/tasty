<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_ProductListThree.ascx.cs" Inherits="UserControls_UC_ProductListThree" %>

<div class="product-list-wrapper">
    <div class="product-list-header">
        <div class="product-cat-title" style="width: 20%;">
            <h1>
    ...
    <div class="product-list-content">
        ...
        <div class="list-item-wrapper-full" style="padding: 1px;">
            <asp:Repeater ID="rptProductList" runat="server" OnItemDataBound="rptProductList_ItemDataBound">
                <ItemTemplate>
                    <div class="product-item-small" style="height:259.5px;">
